...
class ColaboradoresWindow:
    ...
    def create_treeview(self, parent):
        ...
        # Colunas do treeview
        columns = (
            "matricula", "nome", "cpf", "departamento", 
    ...
    def create_form(self, parent):
        ...
        self.form_vars['cpf'] = tk.StringVar()
        cpf_entry = ttk.Entry(pessoais_frame, textvariable=self.form_vars['cpf'], width=20)
        ...
        self.form_vars['uf'] = tk.StringVar()
        uf_combo = ttk.Combobox(endereco_frame, textvariable=self.form_vars['uf'], width=5)
    ...
    def filtrar_colaboradores(self, event=None):
        ...
        for colaborador in self.colaboradores:
            ...
            if busca and busca not in colaborador.get('nome_completo', '').lower() and \
               ...
               busca not in colaborador.get('cpf', '').lower():
                continue
    ...
    def validar_formulario(self):
        ...
        # Validar CPF
        if not self.validar_cpf(self.form_vars['cpf'].get()):
